...
```bash
git clone https://github.com/Gersh13/Ai-Icebreaker-Bot.git
cd icebreaker
```
...
- HaileyTQuach & [IBM Build RAG Applications Course](https://www.coursera.org/learn/build-rag-applications-get-started/)
